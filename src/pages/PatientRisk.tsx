...
const PatientRisk = () => {
  ...
  const getRiskLevelInfo = (level: string) => {
    switch (level.toLowerCase()) {
      case 'high':
        return {
          description: "Your results suggest you may benefit from some extra attention to your cervical health. This is a common finding and simply means your provider may recommend some additional checks to keep you healthy.",
          urgency: "Recommended follow-up",
          followUp: "3-6 months",
          services: ["Colposcopy", "Biopsy", "Specialist consultation"],
          icon: "🔍",
          color: "bg-orange-50 text-orange-700 border-orange-200",
          supportMessage: "It's natural to have questions. Many people need extra checks at some point, and your healthcare team is here to support you every step of the way."
        };
      case 'medium':
        return {
          description: "Your results suggest a follow-up screening could be helpful. This is a routine part of staying healthy and is often just a precaution.",
          urgency: "Regular monitoring recommended",
          followUp: "6-12 months",
          services: ["Pap Smear", "HPV Test", "Follow-up consultation"],
          icon: "📋",
          color: "bg-blue-50 text-blue-700 border-blue-200",
          supportMessage: "Follow-ups are a normal part of care. Most people who have them go on to have normal results."
        };
      case 'low':
        return {
          description: "Your results look good! Keep up with your regular screenings as recommended by your healthcare provider.",
          urgency: "Continue regular screening",
          followUp: "1-3 years",
          services: ["Regular Pap Smear", "HPV Test"],
          icon: "✅",
          color: "bg-green-50 text-green-700 border-green-200",
          supportMessage: "Great news! Staying on top of your screenings is the best way to protect your health."
        };
      default:
        return {
          ...
          {result && (
            <div className="space-y-6">
              ...
              {(() => {
                ...
                return (
                  <div className={`text-center p-6 rounded-lg ${riskInfo.color}`}>
